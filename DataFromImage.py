# -*- coding: utf-8 -*-
"""
Created on Sun May  5 05:04:43 2019
...
for ind in range(0, len(classes)):
    ...
    print(commandStr)
    #class_annotations = Popen(commandStr.split(), stdout=PIPE)
    class_annotations = commandStr.split()
    #class_annotations = subprocess.run(commandStr.split(), stdout=subprocess.PIPE).stdout.decode('utf-8')
    class_annotations = str(class_annotations).splitlines()
